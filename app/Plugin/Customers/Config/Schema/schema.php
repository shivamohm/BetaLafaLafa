 ...
 */
class customersSchema extends CakeSchema {
	var $name = 'customers';
	...
	var $user_details = array(
		...
		'customer_id' => array('type' => 'string', 'null' => false, 'default' => NULL, 'length' => 36),
		...
		'indexes' => array('PRIMARY' => array('column' => 'id', 'unique' => 1), 'UNIQUE_PROFILE_PROPERTY' => array('column' => array('field', 'customer_id'), 'unique' => 1))
	);
	var $users = array(
		'id' => array('type' => 'string', 'null' => false, 'default' => NULL, 'length' => 36, 'key' => 'primary'),
