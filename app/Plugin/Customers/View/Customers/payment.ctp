...
<div class="payment index form">
	...
	<fieldset>
		...
		<?php
			...
			echo $this->Form->create('Payment',array('id'=>'frmProductAddStep2'));
			...
			echo $this->Form->input('bank_account', array('maxlength'=>'15', 'value'=>$payments['Payment']['bank_account'],'label' => __d('payment', 'Name on Bank Account')));
			
			$payments['Payment']['acc_no'] = $payments['Payment']['acc_no'] == 0 ? false:$payments['Payment']['acc_no'];
			...
			echo $this->Form->input('acc_no', array('type'=>'text','maxlength'=>'15','value'=>$payments['Payment']['acc_no'], 'label' => __d('payment', 'Bank Account number')));
			echo $this->Form->input('ifsc_code', array('type'=>'text','maxlength'=>'11', 'value'=>$payments['Payment']['ifsc_code'], 'label' => __d('payment', 'IFSC Code for Bank')));
			...
			<?php 
			$payments['Payment']['pincode'] =  $payments['Payment']['pincode'] == 0 ? false:$payments['Payment']['pincode'];
			echo $this->Form->create("Payment", array('id'=>'frmProductAddStep3'));
			echo $this->Form->input('id', array('value'=>$payments['Payment']['id']));
			...
			echo $this->Form->input('state', array('options'=>$this->Customer->state(),'label' => __d('payment', 'State')));
			
			echo $this->Form->input('pincode', array('type'=>'text','maxlength'=>'6','value'=>$payments['Payment']['pincode'], 'label' => __d('payment', 'Postal Code')));
			echo $this->Form->input('mobile', array('type'=>'text','maxlength'=>'10','value'=>$payments['Payment']['mobile'], 'label' => __d('payment', 'Contact Number')));
			echo $this->Form->end(__d('payment', 'Save Changes'));
			echo "</div>";
		?>
	</fieldset>
