 ...
 */
	public function testRestoreLoginFromCookie() {
		...
		$this->__setPostData(array('Customer' => $this->usersData['test']));
 ...
 */
	public function testRestoreLoginFromCookieIncorrectLogin() {
		...
		// post has "test" data
		$this->__setPostData(array('Customers' => $this->usersData['test']));
		
		$this->RememberMe->restoreLoginFromCookie();

		$this->assertEqual($this->RememberMe->request->data, array(
			'Customers' => $this->usersData['test']));
	}
