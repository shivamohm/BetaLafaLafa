 ...
 */
	...
	public $components = array( 'Auth', 'Session', 'Cookie', 'Paginator', 'Security', 'Search.Prg', 'Customers.RememberMe');
 ...
 */
 public function edit() {
		...
		$userId	=	$this->Auth->user('id');
		 ...
		 $this->Customer->validatePayment['bank_account']=
                                array(                             
                                'notempty' => array(
								'rule' => array('notEmpty'),
            ...
            $this->Customer->validate = $this->Customer->validatePayment;
 ...
 */
	...
	public function payment() {
		...
		$PaymentObj	=	ClassRegistry::init('Payment');
                $payments	=	$PaymentObj->findByCustomerId($this->Auth->user('id'));
		...
		if (!empty($this->request->data)) {
			...
			$this->request->data['Payment']['id']				=	$this->request->data['Customer']['id'];
			
			if($this->request->data['Customer']['neft'] == "yes"){
				
				$this->request->data['Payment']['neft']				=	$this->request->data['Customer']['neft'];
				$this->request->data['Payment']['bank_account']		=	$this->request->data['Customer']['bank_account'];
				$this->request->data['Payment']['bank_name']		=	$this->request->data['Customer']['bank_name'];
				$this->request->data['Payment']['branch_name']		=	$this->request->data['Customer']['branch_name'];
				$this->request->data['Payment']['acc_no']			=	$this->request->data['Customer']['acc_no'];
				$this->request->data['Payment']['ifsc_code']		=	$this->request->data['Customer']['ifsc_code'];
			}
			if($this->request->data['Customer']['cheque'] == "yes"){
				
				$this->request->data['Payment']['cheque']			=	$this->request->data['Customer']['cheque'];
				$this->request->data['Payment']['name_on_address']	=	$this->request->data['Customer']['name_on_address'];
				$this->request->data['Payment']['address']			=	$this->request->data['Customer']['address'];
				$this->request->data['Payment']['city']				=	$this->request->data['Customer']['city'];
				$this->request->data['Payment']['state']			=	$this->request->data['Customer']['state'];
				$this->request->data['Payment']['pincode']			=	$this->request->data['Customer']['pincode'];
				$this->request->data['Payment']['mobile']			=	$this->request->data['Customer']['mobile'];
			}
			
			if($PaymentObj->save($this->request->data)) {
