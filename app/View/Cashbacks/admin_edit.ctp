...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Cashback.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Cashback.id'))); ?></li>
...
<?php echo $this->Form->create('Cashback'); ?>
	<fieldset>
		<legend><?php echo __('Edit Cashback'); ?></legend>
	<?php
