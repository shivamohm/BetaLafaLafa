...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link('List Brand',   array('controller' => 'Brands', 'action' => 'index')); ?></li>
		<li><?php echo $this->Html->link('List Category',   array('controller' => 'Categories', 'action' => 'index')); ?></li>
