...
<?php   if ($this->UserAuth->isAdmin()) { ?>
	...
	<div style="float:left;padding-left:5px"><?php echo $this->Html->link(__("Add Group",true),"/addGroup") ?></div>
	<div style="float:left;padding-left:5px"><?php echo $this->Html->link(__("All Groups",true),"/allGroups") ?></div>
	<div style="float:left;padding-left:5px"><?php echo $this->Html->link(__("Permissions",true),"/permissions") ?></div>
	<div style="float:left;padding-left:5px"><?php echo $this->Html->link(__("Profile",true),"/viewUser/".$this->UserAuth->getUserId()) ?></div>
