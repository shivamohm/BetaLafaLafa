...
<?php echo $this->Form->create('Coupon', array('action'=>'edit')); ?>
	<fieldset>
	...
	<?php
		...
		#echo $this->Form->input('except_category', array('label'=>'Except Category', 'multiple'=>'multiple', 'options'=>$ExceptCategories));
		echo $this->Form->input('except_category', array('label'=>'Except Category', 'type'=>'textarea'));
		...
		echo $this->Form->input('coupon_tag' , array('label'=>'Coupon Tag'));
                echo $this->Form->input('coupontype' , array('label'=>'Coupon Type', 'options'=>array('empty'=>"--select--",'Deal'=>'Deal','Flat Discount'=>'Flat Discount','Freebie'=>'Freebie', 'Buy One Get One free'=>'Buy One Get One free',
